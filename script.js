...
const blogPosts = [
    ...
    },
    {
        ...
        content: `
            ...
            <b>"Siapapun yang takut sama AI tidak akan bisa bertahan di industri ini. Dan begitu sebaliknya yang bisa memanfaatkan AI akan menjadi orang paling berharga di industri ini."</b></p>
            
            <h3>Pengen Masuk STAN</h3>
            <p>cita cita atau impian utama gw emang mau jadi Programmer , tapii itu adalah rencana utama gw , dan setiap plan pasti ada kemungkinan
            ...
            karena lulus bakal langsung kerja dan sekdin yang paling pas buat gw itu adalah STAN sebenarnya sih ga pas juga cuman karena ada toleransi Buta Warna aja , yahh lagi lagi buta warna menjadi masalah gw
            ...
            dah segitu aja sih kegalauan gw , Semangat guyss.</p>
        `
    },
    {
        id: 4,
        ...
        content: `
            ...
            <b>( hehehe anak kelas 11 sma udah ngerasa paling ngerti )</b></p>
        `
    },
    {
        id: 5,
        ...
        content: `
            ...
            denger kan ini sih Duo Sakti di dunia komputer , kenapa disebut duo sakti ? karena ini adalah bahasa paling mudah tapi juga sangat powerfull dan cocok banget buat pemula.</p>
            
            <h3>JAVASCRIPT ??</h3>
            <p>apa sih javascript itu ? okey gw ga akan jelaskan dengan bahasa yang ribet simpelnya gini —
            Bayangin, lo lagi bikin maket rumah dari kardus.<br><br>
            HTML itu kerangka rumahnya (tembok, atap, pintu).<br>
            CSS itu cat, hiasan, dan perabotannya (biar rumahnya cakep).<br>
            Nah, JavaScript ini listrik dan perangkat elektroniknya!<br><br>
            Tanpa JavaScript, rumah maket lo itu diem aja. Tapi begitu lo "pasang" JavaScript, lo bisa bikin lampunya nyala-mati, pintunya kebuka sendiri pas ada yang deketin, atau bahkan ada musik yang main pas jendelanya dibuka.<br><br>
            Keren, kan? Itulah kerjaan JavaScript di dunia website. Dia yang bikin website jadi interaktif. Contohnya pas lo klik tombol "Like" di Instagram dan tombolnya langsung berubah warna, waktu kamu lihat notifikasi pop-up "lo punya pesan baru!", atau ngisi formulir pendaftaran dan langsung muncul tulisan "Email tidak valid!" tanpa loading.<br><br>
            Jadi, kalo lo mau fokus bikin website yang keren, interaktif, dan modern, JavaScript itu wajib lo kuasai. Dia ini "nyawa"-nya halaman web.</p>
            
            <h3>Python ??</h3>
            <p>Nah, kalo JavaScript itu spesialisnya website, Python ini kayak kunci Inggris serbaguna. 
            Dia bisa dipake buat macem-macem hal dan yang paling penting, 
            bahasanya super gampang dibaca, mirip kayak bahasa Inggris biasa.<br><br>
            sangking gampangnya liat lah ini: <b>print("Halo Dunia")</b> — dia bakal langsung otomatis nampilin "halo dunia", jadi gampang banget kan.<br><br>
            Karena gampang dan fleksibel, Python dipake di banyak bidang: Bikin Robot atau AI (otaknya mobil tanpa sopir), Analisis Data (para ilmuwan sering pake Python buat ngolah angka seabrek), Bikin Aplikasi Backend (Instagram atau Spotify sebagian besar dibangun pake Python), sampai Bikin Game Simpel.<br><br>
            Jadi, kalau lo suka mecahin masalah, suka sama data, atau pengen bikin program canggih di luar website, Python ini mantep banget dah.</p>
        `
    },
    {
        id: 6,
        ...
        content: `
            ...
            <p>Yo, <em>what's up, guys</em>!</p>
            <p>Gua lagi keracunan parah nih sama dunia robotika. Seriusan. Tiap liat video di YouTube orang bikin robot yang bisa jalan sendiri, rasanya tangan ini gatel pengen ikutan ngoprek. Masalahnya cuma satu: dompet tipis sebagai anak sma, hehe.</p>
            <p>Tapi masa gara-gara duit jadi alesan buat gak berkarya? Enggak dong. Setelah riset sana-sini, <em>scroll</em> Tokopedia berjam-jam, gua bikin sebuah rencana. Sebuah misi yang agak gila: <strong>Gua bakal bikin robot pertama gua dengan budget maksimal Rp 300.000!</strong></p>
            <p>Bisa gak ya? Mari kita bedah bareng-bareng rencana gua!</p>
            
            <h3>Robot Macam Apa yang Mau Dibuat?</h3>
            <p>Oke, dengan budget segitu, jangan ngarep bikin Iron Man dulu ya, haha. Target gua realistis aja: bikin <strong>Robot Penghindar Halangan</strong> (<em>Obstacle Avoiding Robot</em>). Konsepnya simpel banget: robot ini bakal punya roda buat jalan, dan "mata" di bagian depan. Kalo "matanya" ngeliat ada tembok atau halangan di depannya, dia bakal otomatis berhenti, mundur dikit, terus belok cari jalan lain. Keren, kan?</p>
            
            <h3>Daftar Belanjaan & Perkiraan Harga</h3>
            <p>Ini nih bagian paling krusial. Gua udah bikin daftar komponen wajib:</p>
            <ul>
                <li><strong>Arduino Nano</strong> — Rp 55.000</li>
                <li><strong>Sensor Ultrasonik HC-SR04</strong> — Rp 12.000</li>
                <li><strong>Akrilik Chassis Kit 2WD</strong> — Rp 60.000</li>
                <li><strong>Motor Driver L298N</strong> — Rp 15.000</li>
                <li><strong>Tempat Baterai AA (4 Slot)</strong> — Rp 5.000</li>
                <li><strong>Kabel Jumper</strong> — Rp 20.000</li>
            </ul>
            <p>Total: <strong>Rp 167.000</strong> — bahkan gak nyampe 200 ribu! Artinya, gua punya sisa budget lebih dari 100 ribu buat ongkir, baterai, dan komponen tambahan.</p>
            
            <h3>Langkah Selanjutnya</h3>
            <ol>
                <li><strong>Checkout Keranjang!</strong> Belanja semua barang di atas.</li>
                <li><strong>Ngerakit Fisiknya.</strong> Pasang motor dan roda ke chassis akrilik.</li>
                <li><strong>Ngerangkai Elektroniknya.</strong> Sambungin semua komponen pake kabel jumper.</li>
                <li><strong>Ngoding!</strong> Masukin kode program ke Arduino.</li>
                <li><strong>Tes & Doa.</strong> Semoga pas dinyalain gak ada asep ngebul, hahaha.</li>
            </ol>
            <p>Gua bakal <em>update</em> lagi perkembangannya nanti pas barangnya udah dateng. Doain misi gila ini berhasil ya! <em>Peace out!</em></p>
        `
    },
    {
        id: 7,
        ...
        content: `
            ...
            sih keterima itera tapi kalo kalian baca blog gua sebelumnya pas smp kelas 9 kan gw pengennya masuk ITS <b>nah kenapa kok ga milih ITS?</b> soo jadi gw minder karena pas to nilai gw nyampe kepala 6 aja jarang-jarang sedangkan passing grade its aja 700an semua apalagi untuk Teknik Infromatika yang salah satu jurusan favorite disana kan bisa meninggal gw.</p>
    ...
    },
    {
        ...
        content: `
            ...
            dan setiap gw nunggu di WC pasti kayak orang gila diliatin adek-adek kelas kayak "ngapain sih abang itu di depan wc cewe" 
            nah abis dari wc lanjut ke sekret paskib kadang juga ke koperasi dulu beli jajan setelah sampe di sekret paskib, gw nungguin sekaligus jagain dia wudhu dan entah apa fungsinya 
            setelah dia wudhu gw berpamitan untuk bermain bersama teman dan dia sholat , lalu setelah bermain bersama teman dan 
            bel selesai istirahat berbunyi gw pasti langsung bergegas ke sekret untuk nganterin dia ke kelas , pokoknya begitu aja kami di sekolah.</p>
            <p>pokoknya gw ma dia itu pacarannya sewajarnya aja ga yang begitu banget ala ala anak sma tapi romance nya tetep ga ketinggalan 
            ...
            di mata aku, ahh kan jadi nangis ngetiknya jujur aku gamau kamu punya pacar selain aku aku mau kamu setidaknya gabisa lupain aku sampe 30 tahun, aku tau 
            ini egois tapi aku juga manusia , sama satu lagi semangat yaa di unpadnya jaga diri kamu baik-baik jangan aneh-aneh(hihii) aku bangga banget sama kamu dan akan begitu seterusnya , salam buat mamah papah kamu "om tante makasih udah izinin anaknya yang hebat ini pacaran sama rasya....kak 
            putri juga walaupun aku gapernah ketemu dia, pokoknya sukses selalu kalian.</p>
...
function renderBlogCards() {
    ...
    if (toShow.length === 0) {
        grid.innerHTML = `<div style="grid-column:1/-1;text-align:center;padding:3rem;border:3px solid #0a0a0a;background:#FFE500;box-shadow:6px 6px 0 #0a0a0a;font-weight:700;font-size:1.1rem;">Gak ada artikel yang cocok 🤔</div>`;
        return;
    }
    ...
    grid.innerHTML = toShow.map(post => `
        <div class="blog-card" onclick="openModal(${post.id})">
            ...
            <div class="blog-content">
                <span class="blog-category" data-cat="${post.category}">${post.category}</span>
    ...
    loadBtn.style.display = filtered.length > displayedPosts ? 'inline-block' : 'none';
}

function getFilteredPosts() {
    return blogPosts.filter(post => {
        const matchCat = currentFilter === 'all' || post.category === currentFilter;
        const matchSearch = post.title.toLowerCase().includes(currentSearch.toLowerCase()) ||
...
function openModal(id) {
    ...
    document.getElementById('modalBody').innerHTML = `
        ...
        <p class="modal-meta">${post.date} &nbsp;·&nbsp; By ${post.author} &nbsp;·&nbsp; <span style="text-transform:uppercase;font-weight:700">${post.category}</span></p>
